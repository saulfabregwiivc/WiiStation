...
{ //	button	buttonStyle buttonString		x		y		width	height	Up	Dwn	Lft	Rt	clickFunc				returnFunc
	...
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[69],	510.0,	170.0,	115.0,	56.0,	31,	35,	33,	32,	Func_PsxTypeLightgun,	Func_ReturnFromSettingsFrame }  // PSX Controller Type: Lightgun
};
...
void SettingsFrame::activateSubmenu(int submenu)
{
	...
	{						//Config buttons: set visible; set selected
		...
		case SUBMENU_INPUT:
			...
			if (lightGun == LIGHTGUN_ENABLE)FRAME_BUTTONS[58].button->setSelected(true);
